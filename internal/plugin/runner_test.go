...
| :-- | :-: | :-- |
| 🟢 **Covered Instructions** | **97%** (177) | Changed code your tests executed. Higher is better. |
| 🔴 **Missed Instructions** | 3% (5) | Changed code your tests never ran. Lower is better. |
| 📈 Lines With Coverage Data | 8% (182) | Changed lines the coverage tool could track. |
| ⚪ Lines Without Coverage Data | 92% (2216) | Changed lines with no data: comments, blanks, declarations. |
...
| Metric | Result | What it means |
| :-- | :-: | :-- |
| 🟢 **Covered Instructions** | **73%** (8) | Changed code your tests executed. Higher is better. |
| 🔴 **Missed Instructions** | 27% (3) | Changed code your tests never ran. Lower is better. |
| 📈 Lines With Coverage Data | 22% (2) | Changed lines the coverage tool could track. |
| ⚪ Lines Without Coverage Data | 78% (7) | Changed lines with no data: comments, blanks, declarations. |
...
| Metric | Result | What it means |
| :-- | :-: | :-- |
| 🟢 **Covered Instructions** | **88%** (42) | Changed code your tests executed. Higher is better. |
| 🔴 **Missed Instructions** | 12% (6) | Changed code your tests never ran. Lower is better. |
| 📈 Lines With Coverage Data | 53% (8) | Changed lines the coverage tool could track. |
| ⚪ Lines Without Coverage Data | 47% (7) | Changed lines with no data: comments, blanks, declarations. |
